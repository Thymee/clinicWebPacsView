...
var _pointInsideBoundingBox = __webpack_require__(12);
...
exports.default = function (canvas, eventData, targetElement, referenceElement) {
  var cornerstone = _externalModules2.default.cornerstone;
  ...
  var toolData = (0, _toolState.getToolState)(referenceElement, 'stack');
  ...
  (0, _drawTextBox2.default)(context, text, coords.x, coords.y, color);
};
...
exports.default = function (stack, sourceImagePlane, targetImagePlane) {
  var cornerstone = _externalModules2.default.cornerstone;

  sourceImagePlane.rowCosines = (0, _convertToVector2.default)(sourceImagePlane.rowCosines);
  sourceImagePlane.columnCosines = (0, _convertToVector2.default)(sourceImagePlane.columnCosines);

  sourceImagePlane.imagePositionPatient = (0, _convertToVector2.default)(sourceImagePlane.imagePositionPatient);
  targetImagePlane.rowCosines = (0, _convertToVector2.default)(targetImagePlane.rowCosines);
  targetImagePlane.columnCosines = (0, _convertToVector2.default)(targetImagePlane.columnCosines);
  targetImagePlane.imagePositionPatient = (0, _convertToVector2.default)(targetImagePlane.imagePositionPatient);

  var sourceNormal = sourceImagePlane.rowCosines.clone().cross(sourceImagePlane.columnCosines);
  var targetNormal = targetImagePlane.rowCosines.clone().cross(targetImagePlane.columnCosines);

  var pointToImagePlaneDistance = {};
  var newPointToImagePlaneDistance = {};
  var DeltaX = sourceImagePlane.columnPixelSpacing * (sourceImagePlane.columns / 2);

  var DeltaY = sourceImagePlane.rowPixelSpacing * (sourceImagePlane.rows / 2);
  ...
  if (isParallel) {
    stack.imageIds.forEach(function (currentTargetImageId, index) {
      var currentTargetImagePlane = cornerstone.metaData.get('imagePlaneModule', currentTargetImageId);
      ...
      currentTargetImagePlane.rowCosines = (0, _convertToVector2.default)(currentTargetImagePlane.rowCosines);
      currentTargetImagePlane.columnCosines = (0, _convertToVector2.default)(currentTargetImagePlane.columnCosines);
      currentTargetImagePlane.imagePositionPatient = (0, _convertToVector2.default)(currentTargetImagePlane.imagePositionPatient);

      var a = Math.abs(sourceImagePlane.imagePositionPatient.x - currentTargetImagePlane.imagePositionPatient.x);
      var b = Math.abs(sourceImagePlane.imagePositionPatient.y - currentTargetImagePlane.imagePositionPatient.y);
      var c = Math.abs(sourceImagePlane.imagePositionPatient.z - currentTargetImagePlane.imagePositionPatient.z);

      var maxImagePositionPatient = Math.max(a, b, c);
      ...
      var currentTargetNormal = currentTargetImagePlane.rowCosines.clone().cross(currentTargetImagePlane.columnCosines);

      var currentPointToImagePlaneDistance = Math.abs(currentTargetNormal.x * (pos.x - currentTargetImagePlane.imagePositionPatient.x) + currentTargetNormal.y * (pos.y - currentTargetImagePlane.imagePositionPatient.y) + currentTargetNormal.z * (pos.z - currentTargetImagePlane.imagePositionPatient.z));
    ...
    if (pointToImagePlaneDistance.distance < 10) {
      return pointToImagePlaneDistance.index;
    }
  }
};
...
var _mouseButtonTool = __webpack_require__(10);
...
Object.defineProperty(exports, 'referenceLines', {
  enumerable: true,
  get: function get() {
    return _index.referenceLines;
  }
});
Object.defineProperty(exports, 'automaticPlanePositioning', {
  enumerable: true,
  get: function get() {
    return _index.automaticPlanePositioning;
  }
});
...
var _rotationSynchronizer = __webpack_require__(81);

Object.defineProperty(exports, 'rotationSynchronizer', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_rotationSynchronizer).default;
  }
});

var _layoutStackScrollSynchronizer = __webpack_require__(82);

Object.defineProperty(exports, 'layoutStackScrollSynchronizer', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_layoutStackScrollSynchronizer).default;
  }
});

var _automaticPlanePositioningSynchronizer = __webpack_require__(83);

Object.defineProperty(exports, 'automaticPlanePositioningSynchronizer', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_automaticPlanePositioningSynchronizer).default;
  }
});
...
var _timeSeriesSpecificStateManager = __webpack_require__(84);
...
var _stackSpecificStateManager = __webpack_require__(85);
...
var _frameOfReferenceStateManager = __webpack_require__(86);
...
var _appState = __webpack_require__(87);
...
var _stackScroll = __webpack_require__(89);
...
var _playClip = __webpack_require__(94);
...
var _drawHandles = __webpack_require__(11);
...
var _keyboardInput = __webpack_require__(95);
...
var _mouseInput = __webpack_require__(96);
...
var _mouseWheelInput = __webpack_require__(97);
...
var _touchInput = __webpack_require__(98);
...
var _angleTool = __webpack_require__(99);
...
var _arrowAnnotate = __webpack_require__(100);
...
var _crosshairs = __webpack_require__(101);
...
var _doubleTapZoom = __webpack_require__(102);
...
var _dragProbe = __webpack_require__(103);
...
var _ellipticalRoi = __webpack_require__(104);
...
var _freehand = __webpack_require__(105);
...
var _simpleMouseButtonTool = __webpack_require__(18);
...
var _touchTool = __webpack_require__(13);
...
exports.automaticPlanePositioning = exports.referenceLines = undefined;

var _calculateReferenceLine = __webpack_require__(42);

var _calculateReferenceLine2 = _interopRequireDefault(_calculateReferenceLine);

var _calculateAutomaticPlanePositioning = __webpack_require__(43);

var _calculateAutomaticPlanePositioning2 = _interopRequireDefault(_calculateAutomaticPlanePositioning);

var _automaticPlanePositioningTool = __webpack_require__(63);

var _automaticPlanePositioningTool2 = _interopRequireDefault(_automaticPlanePositioningTool);

var _referenceLinesTool = __webpack_require__(64);

var _referenceLinesTool2 = _interopRequireDefault(_referenceLinesTool);

var _renderActiveReferenceLine = __webpack_require__(29);
...
var referenceLines = {
  ...
  tools: _referenceLinesTool2.default,
  renderActiveReferenceLine: _renderActiveReferenceLine2.default
}; /* jshint esversion: 6 */


var automaticPlanePositioning = {
  calculateAutomaticPlanePositioning: _calculateAutomaticPlanePositioning2.default,
  tool: _automaticPlanePositioningTool2.default,
  renderActiveReferenceLine: _renderActiveReferenceLine2.default
};

exports.referenceLines = referenceLines;
exports.automaticPlanePositioning = automaticPlanePositioning;
...
function onImageRendered(e) {
  ...
  _externalModules2.default.cornerstone.setToPixelCoordinateSystem(eventData.enabledElement, canvas.getContext('2d'));
  ...
  enabledElements.forEach(function (referenceEnabledElement) {
    ...
    if(referenceEnabledElement.getAttribute("autoPlanePosition") === "true") {
    	referenceEnabledElement.setAttribute("autoPlanePosition", "false");
    	return;
    }

    if (referenceEnabledElement.getAttribute('mouseWheel')==='true') {
      renderer(canvas, eventData, e.currentTarget, referenceEnabledElement);
//    referenceEnabledElement.setAttribute('mouseWheel', 'false');
    }
  });
}
...
function onImageRendered(e) {
  ...
  if (e.currentTarget.getAttribute('mouseWheel')==='true') {
    return; 
  }
...
function Synchronizer(event, handler) {
  ...
  function fireEvent(sourceElement, eventData) {
    ...
    targetElements.forEach(function (targetElement) {
      ...
      // Thy--autoPlanePosition add a custom data-attribute
...
//  $(e.currentTarget).data('mouseWheel', true); // Thy--mouseWheel element add a custom data-attribute
...
exports.default = function (synchronizer, sourceElement, targetElement) {
  ...
  // Do nothing if the ww/wc already match
  if (targetViewport === undefined || targetViewport.rotation === sourceViewport.rotation) {
    return;
  }
...
exports.default = function (synchronizer, sourceElement, targetElement, eventData) {
  ...
  // Get the stack of the target viewport
  var stackToolDataSource = (0, _toolState.getToolState)(sourceElement, 'stack');
  var stackToolDataTarget = (0, _toolState.getToolState)(targetElement, 'stack');

  if (!stackToolDataSource || !stackToolDataTarget) {
    return;
  }
  var stackDataSource = stackToolDataSource.data[0];
  var stackDataTarget = stackToolDataTarget.data[0];

  //  Get the new index for the stack
  var newImageIdIndex = eventData.newImageIdIndex + (stackDataTarget.layoutIndex - stackDataSource.layoutIndex);

//if (newImageIdIndex > stackDataTarget.imageIds.length - 1) {
//  stackDataTarget.currentImageIdIndex = newImageIdIndex;
//  $(targetElement).hide();
//
...
//
//  var oh = $(targetElement).parent().height() / 2;
//
//  ol.css({ top: oh,
//    left: ow - ol.width() / 2 });
//
...
//bottomRight.show();
  // If the index has not changed, stop here
  if (stackDataTarget.currentImageIdIndex === newImageIdIndex) {
    return;
  }
  $(targetElement).show();
  ...
  if (!stackDataTarget.imageIds[newImageIdIndex]) {
    return;
  }

  if (stackDataTarget.preventCache === true) {
    loader = cornerstone.loadImage(stackDataTarget.imageIds[newImageIdIndex]);
  } else {
    loader = cornerstone.loadAndCacheImage(stackDataTarget.imageIds[newImageIdIndex]);
  }
  ...
  loader.then(function (image) {
    ...
    var imageId = stackDataTarget.imageIds[newImageIdIndex];
...
exports.default = function (synchronizer, sourceElement, targetElement) {
  ...
  var automaticPlanePositioning = (0, _calculateAutomaticPlanePositioning2.default)(targetStackData, sourceImagePlane, targetImagePlane);
  ...
  // Get the new index for the stack
  var newImageIdIndex = automaticPlanePositioning;
...
var toolType = 'stackScroll'; /* jshint esversion: 6 */
...
function mouseWheelCallback(e) {
  ...
  for(let i = 0; i < allViewport.length; i++) {
  	if(allViewport[i].getAttribute('mouseWheel') === 'true') {
  		allViewport[i].setAttribute('mouseWheel', 'false');
  	}
  
  }
  eventData.element.setAttribute('mouseWheel', 'true');// Thy--mouseWheel element add a custom data-attribute
...
var _fusionRenderer = __webpack_require__(93);
...
function playClip(element, framesPerSecond) {
  ...
  var playClipAction = function playClipAction() {
    ...
    if (!playClipData.loop && (newImageIdIndex < 0 || newImageIdIndex >= imageCount)) {
      ...
      var toolPlay = document.getElementsByClassName('tool-play')[0];

      toolPlay.classList.remove('icon-play');
      toolPlay.classList.add('icon-stop');
...
function onImageRendered(e) {
  ...
  for (var i = 0; i < toolData.data.length; i++) {
    ...
    if (meanStdDev && meanStdDev.mean !== undefined) {
      ...
      var meanText = '\u5E73\u5747\u503C: ' + numberWithCommas(meanStdDev.mean.toFixed(2)) + moSuffix;
      // Create a line of text to display the standard deviation and any units that were specified (i.e. HU)
      var stdDevText = '\u6807\u51C6\u5DEE: ' + numberWithCommas(meanStdDev.stdDev.toFixed(2)) + moSuffix;
    ...
    if (area) {
      ...
      var areaText = '\u9762\u79EF: ' + numberWithCommas(area.toFixed(2)) + suffix;
